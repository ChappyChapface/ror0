...
public class OverdriveTableUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public OverdriveTableUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TnunlimitedModMenus.OVERDRIVE_TABLE_UI.get(), id);
