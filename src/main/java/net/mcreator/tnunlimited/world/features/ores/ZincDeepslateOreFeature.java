...
public class ZincDeepslateOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		PLACED_FEATURE = PlacementUtils.register("tnunlimited:zinc_deepslate_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(12), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(20)), BiomeFilter.biome()));
		return FEATURE;
	}
