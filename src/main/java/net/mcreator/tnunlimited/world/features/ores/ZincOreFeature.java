...
public class ZincOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		PLACED_FEATURE = PlacementUtils.register("tnunlimited:zinc_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(12), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(50)), BiomeFilter.biome()));
		return FEATURE;
	}
