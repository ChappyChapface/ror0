...
public class AntlionStatueFeature extends Feature<NoneFeatureConfiguration> {
	public static AntlionStatueFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new AntlionStatueFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("tnunlimited:antlion_statue", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("tnunlimited:antlion_statue", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
