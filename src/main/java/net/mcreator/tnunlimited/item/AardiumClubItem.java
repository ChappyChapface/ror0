...
public class AardiumClubItem extends Item {
	public AardiumClubItem() {
	...
	public Multimap<Attribute, AttributeModifier> getDefaultAttributeModifiers(EquipmentSlot equipmentSlot) {
		if (equipmentSlot == EquipmentSlot.MAINHAND) {
			...
			builder.put(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_UUID, "Tool modifier", 10f, AttributeModifier.Operation.ADDITION));
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A72Charging Speed: \u00A773"));
		list.add(Component.literal("\u00A72Max Charges: \u00A771"));
