...
public class BloodripItem extends Item {
	public BloodripItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BloodripShootProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A7eMana Usage: \u00A772"));
		list.add(Component.literal("\u00A77When used:"));
		list.add(Component.literal("\u00A72 12 Damage"));
		list.add(Component.literal("\u00A72 0.5 Attack Speed"));
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		BloodripShootProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getPlayer(), context.getItemInHand());
