...
public class DivineCodexItem extends Item {
	public DivineCodexItem() {
		super(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).durability(2561));
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		DivineCodexShootProcedure.execute();
		return ar;
	}
